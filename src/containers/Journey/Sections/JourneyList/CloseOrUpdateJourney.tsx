...
export const CloseOrUpdateJourney = ({
  players,
  journey
}: CloseOrUpdateJourneyProps) => {
        ...
        <Box display="flex" flexWrap="wrap" gridGap={16}>
          <form className={classes.root} autoComplete="off">
            ...
            <span className={classes.group}>
              ...
              <FormControl className={classes.formControl}>
                <InputLabel htmlFor="biggestEliminator">
                  Maior ELiminador
                </InputLabel>
                <Select
  ...
  const handleShowModal = () => {
    if (isOpen) {
      showModal(ModalCloseJourney, ActionsModalCloseJourney);
    }
  };
  ...
  return (
    <Box display="flex" gridGap={16} pb={3}>
      <Button
      ...
      <Button
        variant="outlined"
        color="primary"
        onClick={() => showModal(ModalCloseJourney, ActionsModalCloseJourney)}
      >
        Atribuir Pontuação.
      </Button>
    </Box>
